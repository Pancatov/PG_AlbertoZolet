...
void SceneManager::update()
{
	...
	{
	case esquerda:
		camadas[4].objects[0]->setPosX(camadas[4].objects[0]->getPosX() - camadas[4].getDesloc());
		break;
	case direita:
		camadas[4].objects[0]->setPosX(camadas[4].objects[0]->getPosX() + camadas[4].getDesloc());
		break;
	...
	else if ((camadas[4].objects[0]->getPosX()-31 <= camadas[5].objects[0]->getPosX() + 32.5f )&&(camadas[4].objects[0]->getPosX()> camadas[5].objects[0]->getPosX()))
	{
		camadas[5].objects[0]->setPosX(1200.0f);
	}
}
...
void SceneManager::setupScene()
{
	...
	camadas[0].objects[0]->setTexture(texID);
	camadas[0].objects[1]->setTexture(texID);
	//camadas[0].objects[1]->setTexture(texID);
	texID = loadTexture("../textures/Camada2.png");
	camadas[1].objects[0]->setTexture(texID);
	camadas[1].objects[1]->setTexture(texID);

	texID = loadTexture("../textures/Camada1.png");
	camadas[2].objects[0]->setTexture(texID);
	camadas[2].objects[1]->setTexture(texID);

	texID = loadTexture("../textures/Chao.png");
	camadas[3].objects[0]->setTexture(texID);
	camadas[3].objects[1]->setTexture(texID);

	texID = loadTexture("../textures/Quadro1D.png");
	camadas[4].objects[0]->setTexture(texID);

	texID = loadTexture("../textures/Beterraba.png");
	camadas[5].objects[0]->setTexture(texID);
